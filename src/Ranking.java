...
public class Ranking {
    ...
    /** Return the best players (index 0 = payer name, 1 = score) */
    public String[][] getTopUser() {
        ...
        try {
            ResultSet score = stm.executeQuery("SELECT * FROM record ORDER BY score DESC LIMIT 10;");   // Get the best player from database
    ...
    public int insertUserName(String userName) {
        ...
        do {
            try {
                insert = stm.executeUpdate("INSERT INTO record (name, score) VALUES ('"+ userName +"', '0');"); // Insert player name to database
